      ...
      <div className="row">
        <div className="col-lg-10 mx-auto">
          ...
          <section className="mb-5">
            ...
            <p>
              <strong>Association Phoenix Accueil</strong>
              <br />
            ...
            <p>
              <strong>SIRET :</strong> 479 854 694 000 22
              <br />
              <strong>NAF :</strong> 8790A
              <br />
              <strong>Email :</strong>{" "}
              <a href="mailto:responsable-lva@phoenixaccueil.org">
                responsable-lva@phoenixaccueil.org
              </a>
              <br />
              <strong>Téléphone :</strong>{" "}
              <a href="tel:+33680422230">06 58 77 21 56</a>
            </p>
            <p>
              <strong>Conseil d&apos;Administration :</strong>
              <br />
              Président : Thierry Duclos
              <br />
              Trésorier : Laurent Thibault
              <br />
          ...
          <section className="mb-5">
            ...
            <p>
              ...
              France
              <br />
              Téléphone : <a href="tel:+33444446040">04 44 44 60 40</a>
              <br />
              Site web :{" "}
              <a
          ...
          <section className="mb-5">
            ...
            <p>
              ...
              (coordonnées disponibles dans la section Contact).
            </p>
            <p>
              Les données collectées via le formulaire de contact sont
              uniquement destinées à Phoenix Accueil et ne seront en aucun cas
              cédées à des tiers. Elles sont utilisées exclusivement pour
              répondre à vos demandes d&apos;information ou d&apos;orientation.
            </p>
          </section>
          ...
          <section className="mb-5">
            <h2>Cookies</h2>
            <p>
              Ce site n&apos;utilise aucun cookie. Aucune donnée n&apos;est
              collectée via des cookies, aucun cookie de tracking, analytique ou
              publicitaire n&apos;est déposé sur votre appareil.
            </p>
          </section>
          ...
          <section className="mb-5">
            <h2>Crédits</h2>
            <p>
              Conception et développement : Site web réalisé pour Phoenix
              Accueil
              <br />
          ...
          <section className="mb-5">
            ...
            <p>
              ...
              internet en direction d&apos;autres sites et/ou de pages
          ...
          <section className="mb-5">
            ...
            <p>
              ...
              l&apos;interprétation ou de l&apos;exécution de celles-ci seront
