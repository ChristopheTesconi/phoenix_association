...
export const metadata: Metadata = {
  title: {
    default:
      "Phoenix Accueil - Lieu de Vie et d'Accueil Gard | Rodilhan & Nîmes",
    template: "%s | Phoenix Accueil",
  },
  description:
    "Lieu de Vie et d'Accueil pour enfants, adolescents et jeunes majeurs en protection de l'enfance à Rodilhan et Nîmes (Gard). Accompagnement éducatif personnalisé, accueil permanent et séquentiel. 20 ans d'expérience dans l'accompagnement global des jeunes en difficulté.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "Lieu de Vie et d'Accueil pour enfants, adolescents et jeunes majeurs en protection de l'enfance à Rodilhan et Nîmes (Gard). Accompagnement éducatif personnalisé, accueil permanent et séquentiel. 20 ans d'expérience.",
    images: [
      {
        url: "/phoenix_fav.JPG",
        width: 1200,
  ...
  twitter: {
    ...
    title: "Phoenix Accueil - Lieu de Vie et d'Accueil Gard | Rodilhan & Nîmes",
    description:
      "Lieu de Vie et d'Accueil pour enfants, adolescents et jeunes majeurs en protection de l'enfance. Accompagnement éducatif personnalisé depuis 20 ans.",
    ...
    makesOffer: [
      {
        ...
        itemOffered: {
          ...
          description:
            "Accueil à temps complet pour les enfants et adolescents nécessitant un cadre de vie stable et sécurisant",
        },
      },
      {
        "@type": "Offer",
        itemOffered: {
          ...
          description:
            "Accueil dans notre annexe à Nîmes pour 3 jeunes majeurs, avec un accompagnement vers l'autonomie complète",
        },
      },
    ],
  };
    ...
    <html lang="fr">
      <head>
        ...
        <meta
          ...
          content="RCXbaBntQ_8NnTbuy8S4KirkBMR7M9cPNxvCs2gRb1o"
        />
        <script
      ...
      <body className="bg-light" suppressHydrationWarning>
        ...
        {/* Google Analytics */}
        <Script
          src="https://www.googletagmanager.com/gtag/js?id=G-SC5PCDMWH1"
