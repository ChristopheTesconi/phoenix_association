    ...
    <section id="contact" className={`container my-5 ${styles.contactSection}`}>
      <div className="row mb-5">
        <div className="col-lg-10 mx-auto text-center">
          ...
          <p className="lead">
            Pour toute demande d&apos;information, d&apos;orientation ou de partenariat, n&apos;hésitez pas à nous contacter.
          </p>
        </div>
      </div>
              ...
              <div className="card h-100 bg-phoenix-blue card-hover">
                <div className="card-body text-center">
                  ...
                  <p className="card-text">
                    <strong>9 rue de la marine</strong><br/>
                    <strong>30230 Rodilhan (Gard)</strong><br/>
                    Villa avec jardin et piscine<br/>
                    <small className="text-muted">7 chambres individuelles</small><br/>
            ...
            <div className="col-md-6">
              <div className="card h-100 bg-phoenix-blue card-hover">
                <div className="card-body text-center">
                  ...
                  <p className="card-text">
                    <strong>49 rue Salomon Reinach</strong><br/>
                    <strong>30000 Nîmes (Gard)</strong><br/>
                    Accompagnement vers l&apos;autonomie<br/>
          ...
          <div className="row mt-4">
            <div className="col-md-6">
              <div className="card h-100 bg-phoenix-blue card-hover">
                <div className="card-body text-center">
                  <div className="fs-1 mb-3">🌱</div>
                  <h5 className="card-title">Éco-lieu &quot;La Vigière&quot;</h5>
                  <p className="card-text">
                    <strong>Remoulins, lieu-dit la Vigière (Gard)</strong><br/>
                    Jardin partagé en partenariat avec le D&apos;ITEP Le Grézan<br/>
                    <small className="text-muted">
                      Ateliers de jardinage, travail du bois, sculpture sur pierre,
                      balades à vélo vers le Pont du Gard
                    </small>
                  </p>
                </div>
              </div>
            ...
            <div className="col-md-6">
              <div className="card h-100 bg-phoenix-blue card-hover">
                <div className="card-body text-center">
                  ...
                  <p className="card-text">
                    <strong>Camping de l&apos;Espiguette - Grau-du-Roi</strong><br/>
                    Séjours de 3 à 4 jours (octobre à avril)<br/>
                    <small className="text-muted">
                      Week-ends et vacances scolaires pour détente et activités éducatives
                    </small>
                  </p>
                </div>
              </div>
